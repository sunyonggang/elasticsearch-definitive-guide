...
无法进行 query，就让它们烂在数据仓库里面。

Elasticsearch 是你最好的新朋友。
--

include::010_入门.asciidoc[]

include::020_分布式集群.asciidoc[]

include::030_输入输出.asciidoc[]

include::040_分布式CRUD.asciidoc[]

include::050_搜索.asciidoc[]

include::052_映射与分析.asciidoc[]

include::054_查询表达式.asciidoc[]

include::056_排序.asciidoc[]

include::060_分布式搜索.asciidoc[]

include::070_索引管理.asciidoc[]

include::075_分片原理.asciidoc[]
